  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-pw-white">Activity Log</h1>
          <p className="text-pw-gray">Track your engagement and history on PathWise.</p>
        </div>
      </div>

      <div className="bg-pw-surface border border-pw-white/10 rounded-3xl p-6 md:p-8">
        {loading ? (
          ...
          <div className="relative border-l border-pw-white/10 ml-4 space-y-8 pb-4">
            {logs.map((log, idx) => (
              <div key={log.id} className="relative pl-8">
                ...
                <div className="bg-pw-black border border-pw-white/5 rounded-2xl p-4 hover:border-pw-white/20 transition-colors">
                  <h4 className="font-bold text-pw-white capitalize mb-1">
