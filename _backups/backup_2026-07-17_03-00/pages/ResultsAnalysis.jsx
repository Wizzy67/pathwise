  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-black text-pw-white tracking-tight flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-pw-surface border border-pw-white/5 rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.2)]">
