  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-pw-white">Saved Careers</h1>
      ...
      {loading ? (
        ...
        <div className="bg-pw-surface border border-dashed border-pw-white/10 rounded-3xl p-12 text-center">
            ...
            <div key={career.id} className="bg-pw-surface border border-pw-white/10 rounded-2xl p-6 flex flex-col group hover:border-pw-azure/50 transition-colors">
              <div className="flex justify-between items-start mb-4">
                ...
                <button 
                  ...
                  className="p-2 text-pw-gray hover:text-red-400 hover:bg-red-400/10 rounded-lg transition-colors"
