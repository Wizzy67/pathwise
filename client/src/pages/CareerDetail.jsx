            ...
            {loadingAi && !aiData ? (
              ...
              <>
                ...
                <div className="flex gap-4 mt-2">
                  <div className="flex items-center gap-1.5 text-xs text-pw-gray"><div className="w-3 h-3 rounded-sm bg-pw-azure" /> Current skills</div>
                  ...
                  {jobs.map(job => (
                    ...
                    >
                      ...
                      <div className="flex gap-1.5 mt-2 flex-wrap">
                        {job.tags.map(t => (
                          <span key={t} className="text-[9px] px-1.5 py-0.5 rounded-md bg-pw-blue/5 border border-pw-blue/10 text-pw-blue font-bold">{t}</span>
                        ))}
                      </div>
                    </a>
                  ))}
